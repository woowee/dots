...
" 生成される各ファイルの退避場所
let &directory = s:cache_home . '/_swap'
let &backupdir = s:cache_home . '/_bkups'
let &undodir   = s:cache_home . '/_undo'
...
" Check `ignorecase` & `smartcase`!!
function! s:ChangeToSingleByte() range
    " テーブル生成
    let l:dic = {}
    call extend(l:dic, {'０':'0','１':'1','２':'2','３':'3','４':'4',
                      \ '５':'5','６':'6','７':'7','８':'8','９':'9'})

    call extend(l:dic, {'①':'1','②':'2','③':'3','④':'4','⑤':'5',
                      \'⑥':'6','⑦':'7','⑧':'8','⑨':'9'})

    call extend(l:dic, {'Ａ':'A','Ｂ':'B','Ｃ':'C','Ｄ':'D','Ｅ':'E','Ｆ':'F','Ｇ':'G',
